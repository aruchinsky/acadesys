...
import { BookOpen, CheckCircle2, ClipboardList, GraduationCap, Home, LayoutGrid, UserCog, Users, Wallet } from 'lucide-react';
...
export function AppSidebar() {
    ...
    return (
        <Sidebar
            collapsible="icon"
            variant="inset"
            className="border-r border-[var(--sidebar-border)] bg-[var(--sidebar)] text-[var(--sidebar-foreground)] transition-colors duration-200"
        >
            {/* Header */}
            <SidebarHeader>
                <SidebarMenu>
