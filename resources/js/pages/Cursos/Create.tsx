                ...
                >
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={h.hora_inicio}
                      onChange={(e) =>
                        setData("horarios", data.horarios.map((v, idx) => idx === i ? { ...v, hora_inicio: e.target.value } : v))
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setData("horarios", data.horarios.map((v, idx) => idx === i ? { ...v, duracion_min: e.target.value } : v))
                      }
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <Select
                      value={h.turno}
                      onValueChange={(v) =>
                        setData("horarios", data.horarios.map((v2, idx) => idx === i ? { ...v2, turno: v } : v2))
                      }
                    >
