...
import { ArrowLeft, BookOpen, CalendarDays, CheckCircle2, Clock, History, MapPin, Users } from 'lucide-react';
                    ...
                    <div className="flex flex-wrap justify-end gap-2">
                        ...
                        <Button asChild variant="default" size="sm">
                            <Link href={route('profesor.asistencias.index', { curso_id: data.id })}>
                                <CheckCircle2 className="mr-1 h-4 w-4" /> Gestionar asistencia
                            </Link>
                        </Button>
                            ...
                            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                                {data.horarios.map((h, i) => (
                                    ...
                                    >
                                        ...
                                        {h.turno && <span className="text-xs font-medium text-primary/80">Turno: {h.turno}</span>}
                                    </motion.div>
                                ))}
                            </div>
                        ) : (
