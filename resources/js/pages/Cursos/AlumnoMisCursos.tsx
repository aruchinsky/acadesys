...
import { BookOpen, CalendarDays, CheckCircle2, Clock, Users2 } from 'lucide-react';
                            ...
                            return (
                                <motion.div key={c.id} variants={fade} initial="hidden" animate="visible" custom={i}>
                                    <Card className="flex h-full flex-col border border-border/40 shadow-sm transition hover:shadow-md">
                                        ...
                                        <CardContent className="flex-1 space-y-2 py-4 text-sm text-muted-foreground">
                                        ...
                                        <div className="flex justify-end border-t border-border/30 p-4">
