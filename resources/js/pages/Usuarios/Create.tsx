...
import { AlertTriangle, ArrowLeft, Loader2, Shield, UserPlus } from 'lucide-react';
                ...
                <Card className="border-border shadow-sm">
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {/* CONTRASEÑA */}
                            <div className="rounded-lg border p-4">
                                <h3 className="mb-3 text-sm font-semibold text-muted-foreground">Contraseña</h3>
            ...
            <AlertDialog open={showConfirm} onOpenChange={setShowConfirm}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>¿Seguro que deseas cancelar? Los datos ingresados se perderán.</AlertDialogDescription>
                    </AlertDialogHeader>
